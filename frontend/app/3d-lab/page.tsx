...
export default function LabPage() {
  ...
  // ✅ FIX: Separate state for Blood Vessel — completely independent from Heart Disease
  const [vesselHypertension, setVesselHypertension] = useState(false)
              ...
              <div className="p-8">
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6">
                  ...
                  <div className="mt-4 lg:mt-0 flex gap-3">
                    <button
                      onClick={() => setVesselHypertension(!vesselHypertension)}
                    ...
                    >
                      {vesselHypertension ? '🔴 Hypertensive View' : '🔵 Normal View'}
                    </button>
                  </div>
                </div>
                ...
                <div className="rounded-xl overflow-hidden">
                  <BloodVesselSimulation
                    isHypertension={vesselHypertension}
                    height={520}
                    className="w-full"
                  />
                </div>
